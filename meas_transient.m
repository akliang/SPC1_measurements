...
multi.MMATRIX=[
     %R13  %R14 %R6  %R4  %R3   %R11   %geo.GL  %geo.extra_gatelines
        1    1 1600 1200   1     0       256           64
        1    1 1600 1200   1    255-32    32           32
  %     1    1  800  600   6
  %     1    1 3200 2800   1
  %     1    2 1600 1200   1
  %{
...
if ts(1,2,3)==1; % PSI-1 settings and calculations
    geo.G3GL=geo.GL+geo.extra_gatelines;
    geo.G3GL=geo.GL-1;
end
...
%%{
meas.MeasCond='FloodTransientNoise'; multi.R22=ts(4,0,0); multi.R22=2;
meas.MeasCond='DarkTransientNoise'; multi.R22=ts(4,0,0); multi.R22=2;
multi.RMATRIX=[
   %R1      R26  R27  
      1      0   200
      2      0   200
...
meas.MeasDetails=[ sprintf('%s', meas.MeasCond) ...
    ...
    sprintf( '_%02dR11', multi.R11                 ) ...
    sprintf( '_%02dgeoGL', geo.GL                 ) ...
    sprintf( '_%02dgeoGLextra', geo.extra_gatelines                 ) ...
...
% Jabber notification
tool_notification(flag.jabber&&flag.first_run,env,meas,multi,'started',[0 1]);
