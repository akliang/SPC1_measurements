...
sendscpi 1 'smub.source.func=smua.OUTPUT_DCAMPS';
sendscpi 1 'smub.source.rangei=10e-3'
sendscpi 1 'smub.source.leveli=0'
sendscpi 1 'smub.source.limitv=20'
sendscpi 1 'smub.source.autorangev=smua.AUTORANGE_ON'
sendscpi 1 'display.smua.measure.func=display.MEASURE_DCVOLTS'
...
sendscpi 1 'smub.sense = smua.SENSE_LOCAL'
sendscpi 1 'smub.source.output = smua.OUTPUT_ON'
