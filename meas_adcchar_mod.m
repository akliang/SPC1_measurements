...
setup.G3_adcCards='m1-a4-00-00-00-00-00-00'; % On G3 ADC Board, theyare labeled ADC8-...-1
...
setup.special='';
setup.battery=true;
setup.special='_ADCch10_3'; 
% setup.ADCtype='normal';
% setup.ADCconnected='a2';
setup.ADCtype='+-20V';
setup.ADCconnected='m1';
vlt=-6.450;
%setup.Dpottoch=[8 7 6 5 4 3 2 1 9 0]; %vector which contains the channels the digipots are connected to starting from digipot1.
...
for mid=1:multi.nrofacq; multi.mid=mid;
 ...
 %  multi.DAC=multi.RMATRIX(multi.mid,7);
  ...
  % multi.VADCminus=multi.RMATRIX(multi.mid,8);
   ...
   %g3x.dpvalues=repmat(multi.DAC,1,10);
...
meas.BaseName=[ meas.DirName ...
 ...
 ...   sprintf('_%04dDAC',multi.DAC);
     sprintf('_VADC%04dmV' , round(multi.VADCdV*1000))   ...
