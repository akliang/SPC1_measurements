...
multi.RMATRIX=[
   %R1    R26   R27   R11    R13    R14
    1    1024   F*512   0      24      2
    200   256   F*512   0      24      2
    %{
    400   256   F*512   0      24      2 

    1    1024   F*512   0      22      2
    200   256   F*512   0      22      2 
    400   256   F*512   0      22      2
    
    1    1024   F*512   0      32      2
    200   256   F*512   0      32      2 
    400   256   F*512   0      32      2
    %}
];
clear F;
...
meas.MeasDetails=[ sprintf('%s', meas.MeasCond) ...
    ...
    sprintf( '_arrayLogicDIPs%s',    setup.PF_arrayLogicDIPs        ) ...
