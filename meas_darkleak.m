...
% Gen2 PSI-1 array on Gen
    ...
    geo.G3GL=geo.GL-1;
    geo.DL=512; % actually, 64*3=192, but we need 128*3 data line channels
...
%meas.MeasCond='FirstLight'; multi.R22=14; % setting: PG3,PG4,PG5 (14=8+4+2)
meas.MeasCond='DarkLeak'; multi.R22=14; % setting: PG3,PG4,PG5 (14=8+4+2)
%meas.MeasCond='Qinj'; multi.R22=14; % setting: PG3,PG4,PG5
...
multi.RMATRIX=[ % overnight long run noise measurement
   %R1      R25   R26  R27  
       %1     0   2000   10     % act as ignore cycles, but recorded - at least partially
       1     0     0    50    % act as 500 ignore cycles, but recorded
       1     0     0    500
...
meas.BaseName=[ meas.DirName ...
    ...
    sprintf( '_Voff%s', volt2str(env.V(id.Voff)) ) ... 
    sprintf( '_Qinj%s', volt2str(env.V(id.VQinj)) ) ...
