...
env.V(end+1)=  0.873; id.Vref    =numel(env.V);                             % Vn.Vref=0.856; 2.303  for PSI2/3 cards  %   usually generated by R/R on Masda-R card
...
env.I.V24m=0.100;  % Current in amperes on the BK PRECISION -24V power supply
